...
use base_db::{impl_intern_key, impl_wrapper, CrateId, InternValueTrivial, Upcast};
use hir_def::{
...
pub trait HirDatabase: DefDatabase + Upcast<dyn DefDatabase> + std::fmt::Debug {
    ...
    #[db_ext_macro::cycle(crate::lower::impl_self_ty_recover)]
    ...
    #[db_ext_macro::cycle(crate::lower::generic_defaults_recover)]
