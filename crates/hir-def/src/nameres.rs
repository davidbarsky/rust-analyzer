...
/// There are some data in the defmap (e.g. extern prelude) that is only needed when analyzing
...
impl LocalDefMap {
    pub(crate) const EMPTY: &Self =
        &Self { extern_prelude: FxIndexMap::with_hasher(stdx::BuildHasherDefault::new()) };
