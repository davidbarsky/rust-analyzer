...
use base_db::{CrateId, Db, RootQueryDb, Upcast};
use either::Either;
...
use crate::{
    ...
    body::{scope::ExprScopes, Body, BodyAndSourceMap, BodySourceMap},
    data::{
        adt::{
    ...
    item_tree::{AttrOwner, ItemTree, ItemTreeAndSourceMap, ItemTreeSourceMaps},
